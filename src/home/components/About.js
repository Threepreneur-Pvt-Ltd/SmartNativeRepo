                ...
                <Row>
                  ...
                  <Col>
                    <h4 className="fs-subheading">
                      Smart Natives are prosumers who co-create and inspire
                      people around the globe through the power of sustainable
                      business transformation. We are driving impact across the
                      country to achieve our vision to<br></br>
                      <h3>
                        <strong className="darkblue">
                          {" "}
                          Give every individual the opportunity to attain an
                          excellent skill set and join the journey from Digital
                          to Smart Native.{" "}
                        </strong>
                      </h3>{" "}
                    </h4>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 rightsc">
              ...
              <p>
                We are an international team with different domains. All of us
                share the passion to work with the younger generation.
              </p>
              <p>
                Last year together with a team of students Rinku competed in the
                biggest German school Hackathon #wirfuerschule and was one of
                the 15 winner teams out of the 250 teams.
                <strong>
                  {" "}
                  In 2021 Mohammed and Rinku won the 1st. price in the
                  competition "Ideenwettbewerb" of the Frankfurt University of
                  Applied Sciences.
                </strong>{" "}
              </p>
