...
function BlogSliderHome() {
  ...
  const data = [
    ...
    },
    {
      ...
      description:
        "Designing devices keeping in mind the need to enhance the primary sector of India Agriculture and our Rural Population.",
    ...
    },
    {
      ...
      description:
        "Need to Create intelligent devices to improve commutation sector, transportation and etc.",
    ...
    },
    {
      ...
      description:
        "Creating state-of-the-art solutions to manage and process our agriculture produce.",
    ...
    },
    {
      ...
      description:
        "Need to design drones and robots that can solve some of the pressing challenges of medical emergencies.",
