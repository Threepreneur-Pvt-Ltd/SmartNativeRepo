                ...
                <Row>
                  <Col>
                    <h4 className="fs-subheading">
                      We organize events like hackathons, robotic competitions
                      or bar camps both online and offline.
                    </h4>
                  </Col>
                  <Col>
                    <h4 className="fs-subheading">
                      We work interdisciplinary and combine both digital tools,
                      hands-on methodology. <br />
                      We believe that the combination of analog and digital,
                      tradition and modernity, is key to learning. <br />
                      If you want to organize an event contact us!<br></br> Also
                      check out our workshops and contact us for further
                      information.
                    </h4>
                  </Col>
                </Row>
